...
export const VIEWS: ViewConfig[] = [
  ...
  {
    id: 'disco-circos',
    name: 'Disco/Circos Plot',
    description: 'Circular genome visualization showing mutations, CNVs, and structural variants.',
    icon: '🌀',
    supportedDatasets: ['all'],
    demoUrl: 'http://localhost:5184/',
  },
  {
    id: 'gsea-plot',
    name: 'GSEA Plot',
    description: 'Gene Set Enrichment Analysis with running sum curve and gene barcode.',
    icon: '📈',
    supportedDatasets: ['all'],
    demoUrl: 'http://localhost:5185/',
  },
  {
    id: 'hic-matrix',
    name: 'Hi-C Matrix',
    description: 'Chromatin interaction heatmap showing contact frequency between genomic regions.',
    icon: '🔲',
    supportedDatasets: ['all'],
    demoUrl: 'http://localhost:5186/',
  },
  {
    id: 'bar-chart',
    name: 'Bar Chart',
    description: 'Categorical comparison with grouped or stacked bar visualizations.',
    icon: '📊',
    supportedDatasets: ['all'],
    demoUrl: 'http://localhost:5187/',
  },
  {
    id: 'violin-plot',
    name: 'Violin Plot',
    description: 'Distribution visualization with kernel density estimation and box overlay.',
    icon: '🎻',
    supportedDatasets: ['all'],
    demoUrl: 'http://localhost:5188/',
  },
  {
    id: 'box-plot',
    name: 'Box Plot',
    description: 'Statistical summary showing quartiles, whiskers, and outliers.',
    icon: '📦',
    supportedDatasets: ['all'],
    demoUrl: 'http://localhost:5189/',
  },
  {
    id: 'scatter',
    name: 'Scatter Plot',
